...
|---|---|---|---|
| 1 | **Formal precision** — specify *L₃*, *I∞*, *A*, *χ* rigorously enough to support mathematical development | [0.1](00-foundational/co-admissibility-formalization.md) | UNCERTAIN |
| 2 | **Derivation** — reconstruct Hilbert space, probability, the Born rule, gauge symmetry, relativistic spacetime, field equations, conservation laws from the triad | [2.1](02-variational/lagrangian.md), [2.2](02-variational/born-rule.md) | LOW |
| 3 | **Born measure** — derive the Born rule's form from constraints on *A*, rather than assuming it; and the hard residue: why one admissible branch actualizes rather than another | [2.2](02-variational/born-rule.md), [keystone](00-foundational/actualization-resolution.md) | LOW |
